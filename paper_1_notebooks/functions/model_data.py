...
class myModel:
    ...
    '''
    class for fitting best possible random forest models using available
    trainig data by optimisation of hyperparamaters
    ...
    def evaluate_rfc(self):
        ...
        Evaluates best radom forest classifiers with available data by 10-fold
        stratified cross validation. Within each train fold this again
        undergoes 10-fold stratified cross-validation with grid search to
        identify best hyperparamaters for evaluating best model.

        Paramters : None

        Attributes :

            all attributes are evaluation metrics for 10-fold stratified
            cross validation self.class_f1_scores : numpy array, averaged class
            specific f1 scores self.accuracy_scores : list, accuracy scores
        ...
        if True:
            ...
            for train_index, test_index in skf.split(self.X, self.y):
                ...
                esti = RandomForestClassifier(max_features='auto',
                                              random_state=42,
                                              n_jobs=-1)
                ...
                print('''gridsearch identified optimum paramaters for the
                      current training data fold, now model with optimumn
                ...
                macro_f1_scores.append(f1_score(y_test,
                                                y_pred,
                                                average='macro'))
    ...
    def evaluate_svm(self):
        ...
        Evaluates best support vector machines with available data by 10-fold
        stratified cross validation. Within each train fold this again
        undergoes 10-fold stratified cross-validation with grid search to
        identify best hyperparamaters for evaluating best model.
        ...
        Attributes :
            ...
            self.class_f1_scores : numpy array, averaged class specific f1
            scores self.accuracy_scores : list, accuracy scores
            self.macro_f1_scores : list, overall F1 scores
            self.f1_dict : dictionary, contains class specific f1 scores
            self.feat_imp_dict : dictionary, contains feature important scores
    ...
    def evaluate_knn(self):
        ...
        Evaluates best k-nearest neighbours classifiers with available data by
        10-fold stratified cross validation. Within each train fold
        this again undergoes 10-fold stratified cross-validation with grid
        search to identify best hyperparamaters for evaluating best model.
        ...
        Attributes :
            ...
            self.class_f1_scores : numpy array, averaged class specific
                                   f1 scores
...
class bestHyperparamaters:
    ...
    def get_best_model(self):
        ...
        attributes:
            ...
            self.best_model : sklearn random forest classifier model with best
